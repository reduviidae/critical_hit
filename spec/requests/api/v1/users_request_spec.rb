  ...
  context 'when a query does alter the database' do
    ...
    describe 'POST #create' do
      ...
      context 'without valid params' do
        it 'does not allow creating a user without a required field' do
          binding.pry
          bad_params = { user: user_params[:user].except(:display_name) }
          puts 'pry should have been hit'
          post_create(bad_params)
          binding.pry
          expect { post_create(bad_params) }.to raise 'octopus'
        end
      end
    end
